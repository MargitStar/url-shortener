...
def get_env_vars():
    return (os.environ.get('URL_SHORTENER_DB_USER'), os.environ.get('URL_SHORTENER_DB_PASSWORD'),
            os.environ.get('URL_SHORTENER_DB_HOST'), os.environ.get('URL_SHORTENER_DB_NAME'))
